...
import type { IndicadorRow } from "@/lib/mockData";
...
const STORAGE_KEY = "portal_orcamento_investment_banking";
const TITULO      = "Investment Banking";

export default function OrcamentoInvestmentBankingPage() {
  ...
  return (
    <div>
      <PageHeader title="Orçamento · Receita" subtitle={TITULO} />
