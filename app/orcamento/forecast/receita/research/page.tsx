...
const ORCAMENTO_KEY = "portal_orcamento_research";
const CENARIOS_KEY  = "portal_forecast_receita_research_cenarios";
const VALORES_KEY   = "portal_forecast_receita_research_valores";
const TITULO        = "Research";
...
export default function ForecastReceitaResearchPage() {
