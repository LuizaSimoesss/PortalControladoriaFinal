...
const ORCAMENTO_KEY = "portal_orcamento_investment_banking";
const CENARIOS_KEY  = "portal_forecast_receita_investment_banking_cenarios";
const VALORES_KEY   = "portal_forecast_receita_investment_banking_valores";
const TITULO        = "Investment Banking";
...
export default function ForecastReceitaInvestmentBankingPage() {
