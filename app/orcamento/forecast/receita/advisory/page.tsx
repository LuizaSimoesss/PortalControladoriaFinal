...
const ORCAMENTO_KEY = "portal_orcamento_advisory";
const CENARIOS_KEY  = "portal_forecast_receita_advisory_cenarios";
const VALORES_KEY   = "portal_forecast_receita_advisory_valores";
const TITULO        = "Advisory";
...
export default function ForecastReceitaAdvisoryPage() {
