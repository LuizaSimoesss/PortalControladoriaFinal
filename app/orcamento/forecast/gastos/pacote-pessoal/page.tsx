...
function ComposicaoModal({ linha, ano, onSave, onAutoSave, onClose }: {
  ...
  function addItem() {
    ...
    if (tipoAdicao === "centro_projeto") { newItem.centroId = selCentro; newItem.projetoId = selProjeto; }
...
const ORCAMENTO_KEY = "portal_orcamento_gastos_pacote_pessoal";
const CENARIOS_KEY  = "portal_forecast_gastos_pacote_pessoal_cenarios";
const VALORES_KEY   = "portal_forecast_gastos_pacote_pessoal_valores";
...
export default function ForecastGastosPacotePessoalPage() {
          ...
          <div className="space-y-4">
            <div>
              ...
              <input autoFocus value={nomeModal} onChange={e => setNomeModal(e.target.value)}
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ex: Otimista, Conservador..." />
            </div>
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {CORES_CENARIO.map(cor => (
                  <button key={cor} type="button" onClick={() => setCorModal(cor)}
                    ...
                    style={{ background: cor, borderColor: corModal === cor ? "#1e3a5f" : "transparent", boxShadow: corModal === cor ? "0 0 0 2px white, 0 0 0 4px " + cor : "none" }} />
                ))}
              </div>
            </div>
            <div>
