...
const ORCAMENTO_KEY = "portal_orcamento_gastos_pacote_servicos_especializados";
const CENARIOS_KEY  = "portal_forecast_gastos_pacote_servicos_especializados_cenarios";
const VALORES_KEY   = "portal_forecast_gastos_pacote_servicos_especializados_valores";
const TITULO        = "Pacote de Serviços Especializados";
...
export default function ForecastGastosPacoteServicosEspecializadosPage() {
      ...
      <div className="p-6 space-y-4 min-w-max">
        ...
        {orcBlocos.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">Acesse Orçamento · Pacote de Serviços Especializados para criar blocos e linhas.</p>
          </div>
        )}
