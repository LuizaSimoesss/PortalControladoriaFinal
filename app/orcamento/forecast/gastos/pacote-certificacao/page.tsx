...
const ORCAMENTO_KEY = "portal_orcamento_gastos_pacote_certificacao";
const CENARIOS_KEY  = "portal_forecast_gastos_pacote_certificacao_cenarios";
const VALORES_KEY   = "portal_forecast_gastos_pacote_certificacao_valores";
const TITULO        = "Pacote de Certificação";
...
export default function ForecastGastosPacoteCertificacaoPage() {
