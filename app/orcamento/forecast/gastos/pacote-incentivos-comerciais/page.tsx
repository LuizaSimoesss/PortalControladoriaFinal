...
const ORCAMENTO_KEY = "portal_orcamento_gastos_pacote_incentivos_comerciais";
const CENARIOS_KEY  = "portal_forecast_gastos_pacote_incentivos_comerciais_cenarios";
const VALORES_KEY   = "portal_forecast_gastos_pacote_incentivos_comerciais_valores";
...
export default function ForecastGastosPacoteIncentivosComerciaisPage() {
