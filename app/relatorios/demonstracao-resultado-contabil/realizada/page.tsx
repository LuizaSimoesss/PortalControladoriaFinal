...
export default function DreContabilRealizadaPage() {
  const [dre]        = usePersistedData<DemoItem[]>("portal_dre_contabil", []);
  ...
  const [filtros,    setFiltros]    = usePersistedData<Filtros>("portal_dre_contabil_filtros_realizada", filtrosVazios);
  ...
  if (!dataLoaded) {
    return (
      <div>
        <PageHeader title="DRE - Contábil" subtitle="Realizado" />
  ...
  return (
    <div>
      <PageHeader title="DRE - Contábil" subtitle={subtitle} />
