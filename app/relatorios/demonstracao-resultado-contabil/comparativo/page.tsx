...
export default function DreContabilComparativoPage() {
  ...
  const [filtros,    setFiltros]    = usePersistedData<Filtros>("portal_dre_contabil_filtros_comparativo", filtrosVazios);
  ...
  if (!dataLoaded) {
    return (
      <div>
        <PageHeader title="DRE - Contábil" subtitle="Comparativo Orçado × Realizado" />
